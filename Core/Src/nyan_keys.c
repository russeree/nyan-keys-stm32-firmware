...
static uint8_t keys_registers_addresses[] = {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x00}; // We need the last dummy byte to extract the last byte from the keys IP
