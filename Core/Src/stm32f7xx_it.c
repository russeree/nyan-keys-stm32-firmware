...
/* USER CODE BEGIN EV */
extern NyanOS nos;
extern double system_status_led_angle;
/* USER CODE END EV */
...
void TIM1_CC_IRQHandler(void)
{
  ...
  // This has be be in here, otherwise the system halts when using other timers !!!FIXME!!! Advanced TIM8 might be a candidate later.
